...
describe("число из поля ввода", () => {
  it("запятая и пробелы разрядов — как набирают руками: «1 500,50» → 1500.5", () => {
    // На экране сдачи набранное «150,50» превращалось в NaN: «Укажите сумму
    // оплаты» при сумме на экране и «NaN» в долге — уже после того, как товар
    // отдан.

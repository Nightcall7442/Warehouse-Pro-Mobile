...
export default function NewOrderScreen() {
  ...
  // If params already specify a shop/product, skip draft check (adjusting state during render)
  const hasParams = !!(params.shopId || params.productId);
  if (hasParams && !draftChecked) {

...
import { View, Text, RefreshControl, ScrollView, Modal, Pressable, FlatList } from "react-native";
      ...
      {isLoading ? (
        ...
        <ScrollView contentContainerStyle={{ paddingTop: Spacing.lg, paddingBottom: insets.bottom + 100 }} showsVerticalScrollIndicator={false}
          ...
          <PressableScale onPress={() => { setSelectedTerritory("__all__"); }} haptic="none" style={{ marginBottom: Spacing.sm }}>
            <Card>
              <View style={{ flexDirection: "row", alignItems: "center", gap: Spacing.md }}>
                <View style={{ width: 48, height: 48, borderRadius: Radii.lg, backgroundColor: colors.brand.primaryDim, alignItems: "center", justifyContent: "center" }}>
          ...
          {territories.map((group, idx) => (
            <FadeInItem key={group.territory} delay={idx * 40} style={{ marginBottom: Spacing.sm }}>

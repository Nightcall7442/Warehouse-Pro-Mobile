// Warehouse Pro — Login v2 (cold palette, Card, Button, PressableScale)
    ...
    <View style={{ flex: 1, backgroundColor: colors.bg.primary }}>
      <KeyboardAvoidingView style={{ flex: 1 }} behavior="padding">
        <ScrollView contentContainerStyle={{ flexGrow: 1, justifyContent: "center", padding: Spacing.xl }} keyboardShouldPersistTaps="handled">
          ...
          {/* Form card */}
          <Card style={{ padding: Spacing.xl, paddingBottom: 36, position: "relative", zIndex: 1 }}>
            <CardDots />
            ...
            <View style={{ marginBottom: Spacing.base }}>
              ...
              <View style={{ flexDirection: "row", alignItems: "center", backgroundColor: colors.bg.input, borderRadius: Radii.lg, borderWidth: 1, borderColor: colors.border.default }}>
            ...
            {/* Login button */}
            <Button variant="primary" size="lg" fullWidth icon="log-in" loading={loading} onPress={handleLogin}>
              Войти
            </Button>
            ...
            {capabilities.hasHardware && capabilities.isEnrolled && biometricEnabled && (
              <PressableScale onPress={handleBiometricLogin} disabled={biometricLoading} haptic="medium">
                <View style={{ flexDirection: "row", alignItems: "center", justifyContent: "center", gap: 10, marginTop: Spacing.base, paddingVertical: Spacing.md, borderRadius: Radii.md, backgroundColor: colors.bg.elevated, borderWidth: 1, borderColor: colors.border.default }}>
